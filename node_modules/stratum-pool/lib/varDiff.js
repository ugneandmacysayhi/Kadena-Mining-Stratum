...
var varDiff = module.exports = function varDiff(port, varDiffOptions) {
    ...
    this.manageClient = function(client) {
        ...
        client.on('submit', vardiffHandler = function() {

		    /*
            // and remove the vardiff listener
            if (client.userSetDifficulty){
                _this.emit('newDifficulty', client, client.userSetDifficulty);
                client.removeListener('submit', vardiffHandler);
                //console.log("**** vardiff listener removed ****");
                return
            }
            */
            ...
            //console.log("avg=" + avg+ "tmax=" + tMax + " tMin=" + tMin + " ddiff=" + ddiff);
            ...
            //console.log("varDiff new diff. current:" + client.difficulty + " new:" + client.difficulty * ddiff + " ddiff:" + ddiff);
            var newDiff = Math.round(client.difficulty * ddiff);
            timeBuffer.clear();

	        //console.log("**** varDiff newDifficulty. client.difficulty=" + client.difficulty + " ddiff=" + ddiff+ "  newDiff="+newDiff);
